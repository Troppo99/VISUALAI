    ...
    def process_frames(self):
        while not self.stop_event.is_set():
            ...
            if self.show_reference:
                ...
                cv2.imshow("DifferDetector", combo)
            else:
                cv2.imshow("DifferDetector", output)
...
def main():
    ...
    try:
        ad = DifferDetector(video_source="rtsp", rois=rois, reference_filename=reference_filename, ip_camera=ip_camera)
