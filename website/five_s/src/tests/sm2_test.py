...
class SpreadingManual:
    ...
    def process_frame(self, frame):
        ...
        # Kesimpulan
        if self.blazing_moving and self.bullmer_idle:
            conclusion = "SPREADING MANUAL"
            print(conclusion)
            # Reset flag setelah kesimpulan
            self.blazing_moving = False
        elif not self.blazing_moving and not self.bullmer_idle:
            conclusion = "SPREADING DENGAN BULLMER"
            print(conclusion)
            # Reset flag setelah kesimpulan
            self.bullmer_idle = True
        # Jika tidak memenuhi kondisi di atas, tidak ada kesimpulan yang dicetak
